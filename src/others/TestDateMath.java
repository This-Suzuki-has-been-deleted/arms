...
public class TestDateMath {
	...
	public void testDiff() throws ParseException{
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
		Date temp_date1 = sdf.parse("2018/01/01 00:20:00");
	...
	public void testFixedTime(){
		assertEquals("18時ではない",1514797200000L,dateMath.fixedTime(2018,1,1));
	}

	@Test
	//正しく指定した日の22時が出るか
	public void testOverTime(){
		assertEquals("22時ではない",1514811600000L,dateMath.overTime(2018, 1, 1));
	}
	@Test
	//年月日時分が取り除かれているか
